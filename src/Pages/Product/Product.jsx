...
import prodcut1 from "../../assets/app-1.jpeg";
import prodcut2 from "../../assets/app-2.jpeg";
import prodcut3 from "../../assets/app-3.jpeg";
import prodcut4 from "../../assets/app-4.jpeg";
import prodcut5 from "../../assets/app-5.jpeg";
import prodcut6 from "../../assets/app-6.jpeg";
...
const Product = () => {
  ...
  return (
    <div className="bg-[#bdc3c7]">
      <div className=" pt-44 max-w-[1200px] mx-auto flex">
        <div className="category w-[300px]">
          <div className="app px-2 relative h-[65vh] bg-white mr-1">
